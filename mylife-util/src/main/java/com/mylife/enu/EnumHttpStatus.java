package com.mylife.enu;

/**
 * @descirption : http状态码枚举
 * @author : wyh
 * @date : 2020/9/2 10:12
 */
public enum EnumHttpStatus {
    ...
    EnumHttpStatus(int code, String reasonPhraseUS, String reasonPhraseCN) {
        this.code = code;
    ...
    public static EnumHttpStatus valueOf(int code) {
        for (EnumHttpStatus httpStatus : values()) {
